...
export default function FairyNamesPage() {
  ...
  return (
    <FairySiteLayout>
      ...
      <section
        id="fairy-name-list"
        className="scroll-mt-24 bg-surface-container-low px-6 py-16"
      >
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 lg:grid lg:grid-cols-[4.5rem_minmax(0,1fr)] lg:gap-8">
            <nav
              ...
              className="sticky top-20 z-30 -mx-6 border-y border-outline-variant bg-surface-container-low/95 px-6 py-3 backdrop-blur lg:top-24 lg:mx-0 lg:max-h-[calc(100vh-7rem)] lg:self-start lg:overflow-y-auto lg:rounded-2xl lg:border lg:bg-white lg:p-3 lg:shadow-sm"
            >
                ...
                >
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {fairies.map((fairy) => (
                      <article
                        key={fairy.id}
                        className="flex gap-4 rounded-2xl border border-outline-variant bg-white p-3 shadow-sm"
                      >
                        <button
                          type="button"
                          className="group relative h-28 w-20 shrink-0 overflow-hidden rounded-xl bg-surface-container-low text-left focus:outline-none focus:ring-4 focus:ring-primary/25"
                        ...
                        <div className="min-w-0 py-1">
                          ...
                          <h4 className="mt-2 text-base font-bold leading-6 text-on-surface">
                            {fairy.fullTitle}
                          </h4>
                        </div>
                      </article>
